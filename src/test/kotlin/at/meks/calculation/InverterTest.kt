...
class InverterTest {
    ...
    inner class FedIn {
        ...
        fun withinOneMonth() {
            ...
            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 1, 0, 15), 1.0, 0.8))
            assertThatNothingWasFedId(inverter, january)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 1, 0, 30), 3.0, 0.8))
            assertThatNothingWasFedId(inverter, january)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 1, 0, 45), 8.432, 0.8))
            assertFedIn(inverter, january, 0.832)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 1, 1, 0), 10.0, 0.8))
            assertFedIn(inverter, january, 10.032)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 2, 0, 0), 10.0, 0.8))
        ...
        fun differentMonths() {
            ...
            inverter.add(SinglePowerData(LocalDateTime.of(2025, 1, 1, 0, 15), 14.0, 0.8))
            assertFedIn(inverter, january, 4.0)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 2, 1, 0, 15), 13.0, 2.8))
            assertFedIn(inverter, february, 13.0 - 2.8)

            inverter.add(SinglePowerData(LocalDateTime.of(2025, 3, 1, 0, 15), 15.432, 0.72))
